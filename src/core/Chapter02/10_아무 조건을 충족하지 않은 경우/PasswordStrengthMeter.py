...
class PasswordStrengthMeter:
    ...
    def get_meter(self, password):
        ...
        if all([not containsUpp, not containsNum, not lengthEnough]): return PasswordStrength.약함
        ...
        if all([containsUpp, not containsNum, not lengthEnough]): return PasswordStrength.약함
